...
<section class="intro-capacitacion">
    <div class="container-fluid px-0">
        <div class="row">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 px-0 d-flex align-content-center justify-content-center display-1 titulo-capacitacion">
                CAPACITACIÓN
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 px-0">
    ...
    <div class="container py-5">
        <form action="vendor/Correos/mail.php" method="POST">
            ...
            <div class="form-group row py-2">
                <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9 col-sm-11 col-xs-11 col-11 fs-1 mx-auto text-center">
            ...
            <div class="form-group row py-2">
                ...
                <div class="col-xxl-1 col-xl-1 col-lg-1 col-md-9 col-sm-12 col-xs-12 col-12 mx-xxl-0 mx-xl-0 mx-lg-0 mx-md-auto mx-sm-auto mx-xs-auto mx-auto">
                    <label for="edad">Edad</label>
                    <input type="number" name="edad" class="form-control">
                </div>
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-9 col-sm-12 col-xs-12 col-12 mx-xxl-0 mx-xl-0 mx-lg-0 mx-md-auto mx-sm-auto mx-xs-auto mx-auto">
                    <label for="fecha">Fecha de nacimiento</label>
                    <input type="date" name="fecha" class="form-control">
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-9 col-sm-12 col-xs-12 col-12 mx-xxl-0 mx-xl-0 mx-lg-0 mx-md-auto mx-sm-auto mx-xs-auto mx-auto">
            ...
            <div class="form-group row py-2">
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-9 col-sm-12 col-xs-12 col-12 mx-auto">
